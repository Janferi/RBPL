...
<body>
    <div class="container mx-auto p-5">
        ...
        <header class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4">
                <span class="text-gray-700">Selamat datang, <?php echo htmlspecialchars($_SESSION['username']); ?></span>
                <button onclick="window.location.href='halamanoption.php'" class="bg-gray-500 text-white px-4 py-2 rounded-full hover:bg-gray-600 transition duration-200">
                    <i class="fas fa-arrow-left mr-2"></i>Kembali
                </button>
                <button onclick="window.location.href='logout.php'" class="bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600 transition duration-200">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button onclick="openModal()" class="bg-green-500 text-white px-6 py-3 rounded-full hover:bg-green-600 transition duration-200 flex items-center">
        ...
        <nav class="flex justify-center mb-6 flex-wrap">
            <a href="?category=all">
                <button class="<?= ($category_filter == 'all') ? 'bg-yellow-300' : 'bg-transparent border border-gray-400' ?> px-4 py-2 rounded-full mx-1 transition duration-300 ease-in-out hover:bg-yellow-200">
                    All
                </button>
            </a>
            <?php
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            ?>
                    <div class="bg-white border border-gray-300 p-4 rounded-lg shadow-md card-hover transition-all duration-300">
                        <?php if ($row['gambar']): ?>
                        ...
                        <div class="text-center">
                            ...
                            <div class="flex justify-center space-x-2">
                                <button onclick="editMenu(<?= $row['id'] ?>)" class="bg-blue-500 text-white px-3 py-1 rounded-full text-sm hover:bg-blue-600 transition duration-200">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                                <button onclick="deleteMenu(<?= $row['id'] ?>, '<?= $name ?>')" class="bg-red-500 text-white px-3 py-1 rounded-full text-sm hover:bg-red-600 transition duration-200">
        ...
        <div class="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="harga" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                </div>
                
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Deskripsi</label>
                    <textarea name="deskripsi" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"></textarea>
                </div>
                
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Gambar</label>
                    <input type="file" name="gambar" accept="image/*" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                </div>
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button type="submit" name="tambah_menu" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition duration-200">
                        Tambah Menu
                    </button>
                </div>
            </form>
