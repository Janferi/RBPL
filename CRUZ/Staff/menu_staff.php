...
<body>
  ...
  <?php
    include ("koneksi.php");
    $category = isset($_GET['category']) ? $_GET['category'] : 'all'; // <-- dipindah ke atas
    ?>
...
<div id="side-menu" class="fixed top-0 right-0 h-full w-64 bg-[#DBD19C] z-50 transform translate-x-full transition-transform duration-300 ease-in-out shadow-lg">
