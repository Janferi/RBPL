...
<head>
    ...
    <title>Server Error | CRUZ Coffee</title>
...
<body class="bg-cruz-cream text-cruz-charcoal font-sans antialiased min-h-screen flex items-center justify-center">
    ...
    <div class="text-center px-6">
        <!-- Error Code -->
        <h1 class="text-8xl md:text-9xl font-serif text-cruz-gold mb-4 italic">500</h1>

        <!-- Divider -->
        <div class="w-16 h-[1px] bg-cruz-gold mx-auto mb-8"></div>

        <!-- Message -->
        <h2 class="text-2xl md:text-3xl font-serif text-cruz-black mb-4">Server Error</h2>
